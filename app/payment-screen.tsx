...
const styles = StyleSheet.create({
  ...
  summaryBox: { backgroundColor: '#ffffff', borderWidth: 1, borderColor: '#ffcc80', borderRadius: 10, padding: 16, marginBottom: 16 },
  summaryTitle: { color: '#e65100', fontWeight: '700', fontSize: 16, marginBottom: 12 },
  summaryRow: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 8 },
  summaryLabel: { color: '#000', fontSize: 14 },
  summaryValue: { color: '#000', fontWeight: '600', fontSize: 14 },
  totalRow: { borderTopWidth: 1, borderTopColor: '#ffcc80', paddingTop: 8, marginTop: 8 },
  totalLabel: { color: '#e65100', fontWeight: '700', fontSize: 16 },
  totalValue: { color: '#e65100', fontWeight: '700', fontSize: 18 },
  ...
  paymentBtn: { flex: 1, backgroundColor: '#ffffff', borderWidth: 1, borderColor: '#ffcc80', borderRadius: 10, paddingVertical: 12, marginHorizontal: 4, alignItems: 'center' },
  paymentBtnActive: { backgroundColor: '#ffe0b2', borderColor: '#e65100', borderWidth: 2 },
  paymentText: { color: '#e65100', fontWeight: '600', fontSize: 14 },
  paymentTextActive: { color: '#e65100', fontWeight: '700' },
